...
class TinderStateMachine<STATE : Any, EVENT : Any, SIDE_EFFECT : Any> private constructor(
    ...
    fun with(init: GraphBuilder<STATE, EVENT, SIDE_EFFECT>.() -> Unit): TinderStateMachine<STATE, EVENT, SIDE_EFFECT> {
    ...
    companion object {
        ...
        ): TinderStateMachine<STATE, EVENT, SIDE_EFFECT> {
        ...
        fun <STATE : Any, EVENT : Any, SIDE_EFFECT : Any> create(
            ...
            return TinderStateMachine(GraphBuilder(graph).apply(init).build())
        }

        fun <STATE : Any, EVENT : Any, SIDE_EFFECT : Any> createGraph(
            init: GraphBuilder<STATE, EVENT, SIDE_EFFECT>.() -> Unit
        ): Graph<STATE, EVENT, SIDE_EFFECT> {
            return createGraph(null, init)
        }
        ...
        fun <STATE : Any, EVENT : Any, SIDE_EFFECT : Any> createGraph(
            ...
            return GraphBuilder(graph).apply(init).build()
        }
    }
}
